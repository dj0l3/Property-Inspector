...
public class DirectoryFragment extends Fragment {
    ...
    private String mFilteredFile=".csv";
    private String mDefRootDir;
    ...
    public void setOption(int req){
        mOption=req;
    }
    public void setDefaultRoot(String rootPath){
        mDefRootDir=rootPath;
    }
    ...
    public boolean onBackPressed_() {
        if (history.size() > 0) {
            ...
            if (he.dir != null) {
                ...
                if(mDefRootDir!=null)listFiles(new File(mDefRootDir));
                else listRoots();
            }
        ...
        if (fragmentView == null) {
            ...
            listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                                                    ...
                                                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                                                        if(items.size()<=0||mOption==FilePickerActivity.REQ_PICK_FILE)return false;
                                                        ListItem currentItem=items.get(position);
                                                        if (delegate != null) {
                                                            ArrayList<String> files = new ArrayList<String>();
                                                            files.add(currentItem.file.getAbsolutePath());
                    ...
                    if (file == null) {
                        ...
                        he.dir = currentDir;
                        he.title = title_!=null ? title_.toString() : "";
                        updateName(title_);
                        if (!listFiles(file)) {
                            return;
                        }
    ...
    private boolean listFiles(File dir) {
        ...
        for (File file : files) {
            ...
            if (file.isDirectory()) {
                ...
                if(mOption==FilePickerActivity.REQ_PICK_DIR)continue;

                String fname = file.getName();
                fname = fname.toLowerCase();
                if(!fname.endsWith(mFilteredFile))continue;
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textDetailCell.setBackgroundColor(item.isChecked?0xffbbff:0xffffff);
